...
function Wt(e, t) {
  ...
  if (
    ((E += S), (k.precision = E), (r = Ae(L)), (n = r.charAt(0)), (o = Z(C)), Math.abs(o) < 15e14)
  ) {
  ...
  Yo = ye(() => {
    ...
    _e = (function () {
      ...
      return function (n, i, o, s) {
        ...
        for (
          f = n.e - i.e, xe = z.length, Ke = ve.length, C = new Wr(nu), L = C.d = [], E = 0;
          z[E] == (ve[E] || 0);
...
function Tu(e) {
  let t = {
    ...
    r = (...n) => {
      ...
      if (
        (n.length !== 0 && Kt.push([o, ...n]), Kt.length > xu && Kt.shift(), zt.enabled(o) || i)
      ) {
...
var xa = (e) => (Array.isArray(e) ? e : e.split('.')),
  ...
  Pa = (e, t, r) =>
    xa(t).reduceRight((n, i, o, s) => Object.assign({}, Vi(e, s.slice(0, o)), { [i]: n }), r);
function om(e, t) {
  ...
  async interpretNode(t, r, n, i) {
    switch (t.type) {
      ...
      case 'execute': {
        ...
        for (let a of o)
          s += await this.#u(a, r, () =>
            r.executeRaw(a).catch((f) => (t.args.type === 'rawSql' ? Gi(f) : _t(f)))
          );
        return { value: s };
      }
      case 'query': {
